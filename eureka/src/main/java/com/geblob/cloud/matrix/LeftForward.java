...
public class LeftForward extends DirectionForward {
    public LeftForward(Integer[][] matrix, Pair<Integer, Integer> lengthHeightToCompute, Pair<Integer, Integer> position) {
        this.matrix = matrix;
    ...
    protected void forward() {
        ...
        if (!isTerminated()) {
            ...
            new UpForward(matrix, Pair.with(lengthHeightToCompute.getValue0(),lengthHeightToCompute.getValue1()-1), position).forward();
        }
    }
}

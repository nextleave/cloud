...
public class DownForward extends DirectionForward {
    public DownForward(Integer[][] matrix, Pair<Integer, Integer> lengthHeightToCompute, Pair<Integer, Integer> position) {
        this.matrix = matrix;
    ...
    protected void forward() {
        ...
        if (!isTerminated()) {
            ...
            new LeftForward(matrix, Pair.with(lengthHeightToCompute.getValue0()-1,lengthHeightToCompute.getValue1()), position).forward();
        }
    }
}
